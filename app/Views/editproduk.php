            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="<?= base_url('home/aksi_eproduk')?>" method="POST">
                            <form class="form">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control" placeholder="Nama Produk"
                                                name="nproduk" value="<?= $satu->nama_produk ?? '' ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name-column" class="form-control" placeholder="Harga"
                                                name="hrg" value="<?= $satu->harga ?? '' ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="city-column">Deskripsi</label>
                                            <input type="text" id="city-column" class="form-control" placeholder="Deskripsi" name="desk" value="<?= $satu->deskripsi ?? '' ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="country-floating">Kategori</label>
                                            <select type="text" class="form-control" name="kat" value="<?= $satu->id_kategori ?? '' ?>">
                        echo "<option value="<?= $dua->id_kategori ?>"><?= $dua->nama_kategori?></option>";
                        ...
                        <?php }?>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" name="npen" value="<?= $satu->id_penjual ?? '' ?>">
                        echo "<option value="<?= $tiga->id_penjual ?>"><?= $tiga->nama_penjual?></option>";
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email-id-column" class="form-control" name="stok" 
                                                placeholder="Stok" value="<?= $satu->stok ?? '' ?>">
                                        </div>
                                    </div>
